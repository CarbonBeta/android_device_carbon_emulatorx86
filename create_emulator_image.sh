...
zip -r /tmp/carbon_emulator.zip emulatorx86_64/skins emulatorx86_64/system-qemu.img emulatorx86_64/system/build.prop emulatorx86_64/cache.img emulatorx86_64/userdata.img emulatorx86_64/start_emulator_image.sh emulatorx86_64/advancedFeatures.ini emulatorx86_64/encryptionkey.img emulatorx86_64/kernel-ranchu-64 emulatorx86_64/ramdisk.img
